...
function multiply(a, b) { //eslint-disable-line
  var theProduct = a * b //eslint-disable-line
  var theStrg = `The product of ${a} and ${b} is ${theProduct}.`;

  console.log(theStrg);
  return [theProduct, theStrg];
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var sumOne = sum(sumArr[0], sumArr[1]);
    var solutionFour = sum(sumOne[0],sumArr[2]);
  
  var messageFour = `${sumArr} was passed in as an array of numbers, and ${solutionFour[0]} is their sum.`
  console.log(messageFour);

  return [solutionFour[0], messageFour];
...
function multiplyArray(multArr) {  //eslint-disable-line
  ...
  var finalSol = multiply(multOne[0],multArr[2]);

var messageFive = `The numbers ${multArr} have a product of ${finalSol}. `;
console.log(messageFive);

return [finalSol[0], messageFive];
}
